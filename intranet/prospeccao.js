...
async function moveProspectToClosed(prospectId) {
    ...
    try {
        ...
        await updateDoc(prospectRef, {
            ...
            status: 'Concluído', // This is the key for the closed-clients page query
            productionStatus: 'Novo', // This sets the column on the closed-clients page
            closedAt: serverTimestamp(), // Record when it was closed
            updatedAt: serverTimestamp()
        });
